...
Encoder.load_weights('models/results/AE_CNN_model_v5_refOnly_weights.343-0.02.hdf5',by_name=True)
...
accuracy=np.true_divide(np.sum(label_Y==prediction),len(label_Y)) 
