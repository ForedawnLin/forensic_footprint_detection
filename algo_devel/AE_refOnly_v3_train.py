...
# # checkpoint
filepath="models/AE_refOnly_v3_weights.{epoch:02d}-{val_loss:.2f}.hdf5"
...
loss_file=open('models/loss_ref_v3_1_80.txt','a')
...
autoEncoder_CNN.save('models/AE_refOnly_v3.h5')
autoEncoder_CNN.save_weights("models/AE_refOnly_v3_weights.hdf5")
